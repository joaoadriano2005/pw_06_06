...
if (isset($_POST['submit'])) {
    ...
    // Lê o conteúdo do arquivo de imagem e converte para BLOB
    $conteudo = file_get_contents($imagem);

    $stmt = $mysqli->prepare("INSERT INTO tb_cliente (nr_cpf, nm_cliente, nm_endereco, nr_telefone, nm_bairro, nm_cidade, nr_cep, imagem) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
