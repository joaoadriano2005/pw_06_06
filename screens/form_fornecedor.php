...
if(isset($_POST['submit']))
{
    ...
    $stmt = $mysqli->prepare("INSERT INTO tb_fornecedor(nr_cnpj ,nm_fornecedor, nm_endereco,nr_telefone , nm_bairro, nm_cidade,nr_cep, imagem)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssss", $cnpj, $nome, $endereco, $fone, $bairro, $cidade, $cep, $conteudo);
